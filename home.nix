...
}:
{
  ...
  home.file = {
    "${config.xdg.configHome}/nvim/rocks.toml".source =
      config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/projects/nixos/res/rocks.toml";
    ".pki".source = config.lib.file.mkOutOfStoreSymlink "${config.xdg.stateHome}/pki";
  };
